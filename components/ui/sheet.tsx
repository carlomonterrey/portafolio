...
/* import {IoMdClase} from react-icons/io
  ...
  <SheetPortal>
    ...
    >
      ...
      <SheetPrimitive.Close 
        className="absolute right-4 top-4 rounded-full p-2 hover:bg-gray-200 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-950"
        aria-label="Cerrar"
      >
        <IoMdClose className="text-3xl text-accent" size={18} /> {/* Ajusta el tamaño según sea necesario */}
      </SheetPrimitive.Close>
    </SheetPrimitive.Content>
  </SheetPortal>
))
